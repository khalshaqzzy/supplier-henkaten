...
export const CAPABILITIES: Readonly<Record<RequestPrincipal['role'], ReadonlySet<Capability>>> = {
  ...
  SUPERVISOR: new Set(['SUPPLIER_SELF_SERVICE', 'SUPPLIER_SHIFT_READ', 'SUPPLIER_HENKATEN_READ']),
  LINE_LEADER: new Set([
    'SUPPLIER_SELF_SERVICE',
    'SUPPLIER_SHIFT_READ',
  ...
  QC: new Set(['SUPPLIER_SELF_SERVICE', 'SUPPLIER_SHIFT_READ', 'SUPPLIER_HENKATEN_READ']),
};
