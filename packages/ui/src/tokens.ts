...
export const stateTokens = [
  ...
  token('4m-man', '#DC2626', 'Man category'),
  token('4m-machine', '#2F6FED', 'Machine category'),
  token('4m-material', '#D97706', 'Material category'),
  token('4m-method', '#16A34A', 'Method category'),
] as const;

export const typographyTokens = [
  token('font-sans', '"Inter Variable", Inter, ui-sans-serif, system-ui, sans-serif', 'UI family'),
  ...[
    ['type-11-size', '0.75rem', 'Utility text size'],
    ['type-11-line', '1.125rem', 'Utility text line height'],
    ['type-12-size', '0.8125rem', 'Caption size'],
    ['type-12-line', '1.25rem', 'Caption line height'],
    ['type-13-size', '0.875rem', 'Default UI size'],
    ['type-13-line', '1.375rem', 'Default UI line height'],
    ['type-14-size', '0.9375rem', 'Body size'],
    ['type-14-line', '1.4375rem', 'Body line height'],
    ['type-16-size', '1.0625rem', 'Lead size'],
    ['type-16-line', '1.625rem', 'Lead line height'],
    ['type-18-size', '1.1875rem', 'Section heading'],
    ['type-18-line', '1.75rem', 'Section heading line'],
    ['type-20-size', '1.375rem', 'Page heading small'],
    ['type-20-line', '1.875rem', 'Page heading small line'],
    ['type-24-size', '1.625rem', 'Page heading'],
    ['type-24-line', '2.125rem', 'Page heading line'],
    ['type-30-size', '2rem', 'Display heading'],
    ['type-30-line', '2.5rem', 'Display heading line'],
